{
  "_aide": "Ajoute / modifie les types ici. 'consommeHeures' = true si poser ce code retire des heures de ton compteur. 'minutesParDefaut' = duree retiree (728 = une vacation de 12h08). 'partiel' = true pour saisir un nombre d'heures libre (ex: depart anticipe).",
  "types": [
